    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    userNikName = table.Column<string>(type: "nvarchar(100)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FolloverUserId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FollowLists_AspNetUsers_User1Id",
                        column: x => x.User1Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FollowLists_AspNetUsers_User2Id",
                        column: x => x.User2Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HashTagsPost", x => new { x.PostHashTagsId, x.PostId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowLists_User1Id",
                table: "FollowLists",
                column: "User1Id");

            migrationBuilder.CreateIndex(
                name: "IX_FollowLists_User2Id",
                table: "FollowLists",
                column: "User2Id");
