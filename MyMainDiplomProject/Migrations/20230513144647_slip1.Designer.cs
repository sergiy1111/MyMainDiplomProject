...
namespace MyMainDiplomProject.Migrations
{
    ...
    [Migration("20230513144647_slip1")]
    partial class slip1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HashTagsPost", b =>
                {
                    ...
                    b.Property<int>("PostHashTagsId1")
                        .HasColumnType("int");

                    b.HasKey("PostHashTagsId", "PostHashTagsId1");

                    b.HasIndex("PostHashTagsId1");
